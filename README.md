...
Table 1 shows the results of the evaluated 81 antivirus products. Six of these antiviruses scored above 98%. These antiviruses were: Cyren, MAX, Ad-Aware, MicroWorld-eScan, BitDefender, Webroot. Malware detection indicates that these antivirus programs provide a robust service against cyber-intrusions.
